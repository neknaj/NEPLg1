...
- Documented the supported subset and workflow in README.md. Broader language features from plan.md and doc/starting_detail.md (namespaces, types, overloads, etc.) are still outstanding.
